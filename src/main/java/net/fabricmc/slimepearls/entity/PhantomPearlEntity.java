...
import static net.fabricmc.slimepearls.main.PHANTOMPEARL;

import org.jetbrains.annotations.Nullable;

public class PhantomPearlEntity extends ThrownItemEntity {
    private int numBounces = 16;
        ...
        if (!this.world.isClient && !this.isRemoved()) {
            ...
            if (entity instanceof ServerPlayerEntity) {
                ...
                if (hitResult.getType() == HitResult.Type.BLOCK) {
                    ...
                    this.setVelocity(normal.x, normal.y, normal.z, -1, 0f);
    ...
    public ItemStack asItemStack() {
        ItemStack stack = new ItemStack(main.PHANTOMPEARLITEM);
